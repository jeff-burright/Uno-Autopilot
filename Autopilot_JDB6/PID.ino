 ...
 */
  ...
  void RUDDER_POSITION()
  {
     ...
     counts = analogRead(A0);  // rudder potentiometer pin
...
analogWrite(L_PWM, 0); // Jeff experiment IBT-2
analogWrite(R_PWM, 0);
...
//analogWrite(L_PWM, 255); // Jeff experiment IBT-2
  ...
  {  
    ...
    //  Serial_MotorControl.write(Motor_1_fwd);  //   set motor 1 in reverse, 143 for Qik, 194 for TREX
      ...
      // Serial_MotorControl.write(Motor_1_fwd);
       ...
       //motor.forward();   // L298N comment out
